...
{{< param-table scenario="globals" source="krknctl" group="cerberus" >}}
...
{{< param-table scenario="globals" source="krknctl" group="prometheus" >}}
...
{{< param-table scenario="globals" source="krknctl" group="resiliency" >}}
...
{{< param-table scenario="globals" source="krknctl" group="elasticsearch" >}}
...
{{< param-table scenario="globals" source="krknctl" group="telemetry" >}}
...
{{< param-table scenario="globals" source="krknctl" group="health_check" >}}
...
{{< param-table scenario="globals" source="krknctl" group="kubevirt" >}}
